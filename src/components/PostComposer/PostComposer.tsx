    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between px-1">
                <div onClick={() => message.info("Đang phát triển tính năng")} className="flex-1 flex items-center justify-center gap-2 py-2 hover:bg-gray-100 rounded-lg cursor-pointer transition-colors duration-200 text-gray-600 font-semibold text-[15px]">
