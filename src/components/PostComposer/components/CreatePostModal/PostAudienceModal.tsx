...
const PostAudience = ({
  ...
  return (
    <div className='animate-slide-in-right'>
      ...
      {/* Audience Body */}
      <div className='p-4'>
        <h3 className='text-[17px] font-bold mb-1'>Ai có thể xem bài viết của bạn?</h3>
          ...
          {audienceOptions.map((option) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-6 h-6 rounded-full border-2 shrink-0 flex items-center justify-center transition-colors duration-200 ${
        ...
        <div className='flex items-center justify-between mt-4 pt-2 border-t border-gray-100'>
          <span className='text-[15px] text-gray-500'>Đặt làm đối tượng mặc định.</span>
          <input type='checkbox' disabled className='w-5 h-5 rounded border-gray-300 opacity-40 cursor-not-allowed' />
        </div>
