      ...
      >
        {listFriends.map((item, index) => (
          <SwiperSlide key={index} style={{ width: '172px' }}>
            <div key={index} className='flex flex-col border border-[#cdd0d4] rounded-md shadow-2xs shadow-amber-500'>
              ...
              <div className='flex flex-col px-2 py-1'>
                ...
                <Button className='my-1' type='primary' icon={<UserRoundPlus className='w-4 h-4' />}>
                  Theo dõi
                </Button>
              </div>
            </div>
