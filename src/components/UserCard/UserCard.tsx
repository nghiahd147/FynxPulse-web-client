    ...
    <>
      {userInfo.map((item, index) => {
        return (
          <div
            key={index}
            className='w-full bg-white px-2 py-4 rounded-md border border-gray-200 flex items-center justify-between'
          >
            <div className='flex items-center gap-x-3'>
              ...
              <div className='flex flex-col'>
                ...
                <span className='text-sm text-gray-500 font-medium'>{item.mutual_friends_count} Bạn chung</span>
              </div>
            </div>
                  ...
                  items: [
                    {
                      ...
                      label: (
                        <span
                          ...
                          onClick={() => handleUnfollowUser(item._id as string)}
                        >
                          Bỏ theo dõi
                        </span>
                      ),
